...
class AbstractRuleBuilder<E> {
  ...
  AbstractRuleBuilder lessThan(int min, {String field, String message}) {
    return must((dynamic dyn) => dyn is num && dyn < min, message ?? "Number must be less than $min", field: field);
  }
  ...
  AbstractRuleBuilder lessThanOrEqual(int min, {String field, String message}) {
    return must((dynamic dyn) => dyn is num && dyn <= min, message ?? "Number must be less than or equal to $min", field: field);
  }
  ...
  AbstractRuleBuilder greaterThan(int max, {String field, String message}) {
    return must((dynamic dyn) => dyn is num && dyn > max, message ?? "Number must be greater than $max", field: field);
  }
  ...
  AbstractRuleBuilder greaterThanOrEqual(int max, {String field, String message}) {
    return must((dynamic dyn) => dyn is num && dyn >= max, message ?? "Number must be greater than or equal to $max", field: field);
  }
  ...
  AbstractRuleBuilder must(bool Function(dynamic dyn) validator, String message, {String field}) {
    rules.add(
