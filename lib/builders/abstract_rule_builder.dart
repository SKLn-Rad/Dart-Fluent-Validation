...
class AbstractRuleBuilder<E> {
  ...
  AbstractRuleBuilder isNull({@required String field, String message}) {
    return must((dynamic dyn) => dyn == null, message ?? "Value must be null", field: field, code: "notNull");
  }

  /// Checks if the object is not null
  AbstractRuleBuilder notNull({@required String field, String message}) {
  ...
  AbstractRuleBuilder notEmpty({@required String field, String message}) {
  ...
  AbstractRuleBuilder empty({@required String field, String message}) {
  ...
  AbstractRuleBuilder notEqual(dynamic obj, {@required String field, String message}) {
  ...
  AbstractRuleBuilder equal(dynamic obj, {@required String field, String message}) {
  ...
  AbstractRuleBuilder length(int min, int max, {@required String field, String message}) {
    return must(
  ...
  AbstractRuleBuilder minLength(int min, {@required String field, String message}) {
  ...
  AbstractRuleBuilder maxLength(int max, {@required String field, String message}) {
  ...
  AbstractRuleBuilder lessThan(int min, {@required String field, String message}) {
  ...
  AbstractRuleBuilder lessThanOrEqual(int min, {@required String field, String message}) {
  ...
  AbstractRuleBuilder greaterThan(int max, {@required String field, String message}) {
  ...
  AbstractRuleBuilder greaterThanOrEqual(int max, {@required String field, String message}) {
  ...
  AbstractRuleBuilder isValidEmailAddress({@required String field, String message}) {
  ...
  AbstractRuleBuilder isValidPhoneNumber({@required String field, String message}) {
  ...
  AbstractRuleBuilder isValidNationalInsuranceNumber({@required String field, String message}) {
    return must(
  ...
  AbstractRuleBuilder isValidUKPostCode({@required @required String field, String message}) {
  ...
  AbstractRuleBuilder must(bool Function(dynamic dyn) validator, String message, {@required String field, String code}) {
    rules.add(
