...
abstract class AbstractValidator<E> {
  ...
  AbstractRuleBuilder<E> ruleFor(dynamic Function(E e) func, {required String key}) {
    final AbstractRuleBuilder<E> builder = AbstractRuleBuilder<E>(expression: func, key: key);
